...
import bosch1  from "./images/bosch1.jpg";
import bosch2  from "./images/bosch2.jpg";
import easy  from "./images/easy.png";
import asset  from "./images/asset.jpg";
import adms  from "./images/ADMS.jpg";

const images = [
    { src: asset, title: "Asset Management system", },
    { src: easy, title: "Easytime – Timesheet Dashboard",  },
    { src: bosch1, title: "Predictive Engine – Analytics Overview", },
    { src: bosch2, title: "Predictive Engine – Detailed Insights", },
    { src: adms, title: "ADMS- Accord Document Management System",  },
